	...
	**/
	function run( 
		...
		if( arrayLen( md.properties ) ){
			...
			var hContent = fileRead( '/crud-cbadmin/templates/crud-cbadmin/HandlerContent.txt' );
			// Token replacement
			...
			for( var thisView in views ){
				var vContent = fileRead( '/crud-cbadmin/templates/crud-cbadmin/#thisView#.txt' );
			...
			savecontent variable="local.editorData"{
				include '/crud-cbadmin/templates/crud-cbadmin/editor.cfm';	
			}
			editorData = replaceNoCase( editorData, "%cf", "#chr(60)#cf", "all" );
			editorData = replaceNoCase( editorData, "%/cf", "#chr(60)#/cf", "all" );
			// editor data
			var vContent = fileRead( '/crud-cbadmin/templates/crud-cbadmin/editor.txt' );
			vContent = replacenocase( vContent, "|entity|", entityName, "all" );
			vContent = replacenocase( vContent, "|entityPlural|", arguments.pluralName, "all" );
			...
			savecontent variable="local.tableData"{
				include '/crud-cbadmin/templates/crud-cbadmin/table.cfm';	
			}
			tableData = replaceNoCase( tableData, "%cf", "#chr(60)#cf", "all" );
			tableData = replaceNoCase( tableData, "%/cf", "#chr(60)#/cf", "all" );
			// index data
			var vContent = fileRead( '/crud-cbadmin/templates/crud-cbadmin/index.txt' );
			vContent = replacenocase( vContent, "|entity|", entityName, "all" );
			vContent = replacenocase( vContent, "|entityPlural|", arguments.pluralName, "all" );
			...
			savecontent variable="local.saveData"{
				include '/crud-cbadmin/templates/crud-cbadmin/save.cfm';	
			}
			saveData = replaceNoCase( saveData, "%cf", "#chr(60)#cf", "all" );
			saveData = replaceNoCase( saveData, "%/cf", "#chr(60)#/cf", "all" );
			// index data
			var vContent = fileRead( '/crud-cbadmin/templates/crud-cbadmin/ModelContent.txt' );
			vContent = replacenocase( vContent, "|entity|", entityName, "all" );
			vContent = replacenocase( vContent, "|entityPlural|", arguments.pluralName, "all" );
